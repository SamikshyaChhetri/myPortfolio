...
const SocialMedia = () => {
  return (
    <div className="flex flex-col gap-5 rounded-md p-1">
      ...
      <div>
        <a
          href="https://www.facebook.com/samuu.baniya/"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div>
        <a
          href="https://www.linkedin.com/in/samikshya-b-chhetri-673935257/"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div>
        <a
          href="https://www.threads.net/@samuu_hehe?xmt=AQGz992gLRQMV0cYsTNorZ00iVvOlPK7lmPFWl3jlpCGXVE"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className="flex items-center justify-center rounded-full border border-white/20 p-3 hover:bg-black hover:text-white transition duration-300">
      ...
      <div>
        <a
          href="https://x.com/Samuu_hehe"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className="flex items-center justify-center rounded-full border border-white/20 p-3 hover:bg-[#1DA1F2] hover:text-white transition duration-300">
